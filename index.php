			...
			<div class="row">
				<div class="col-md-2">
					<nav>
						...
						<ul class="nav nav-pills nav-stacked">
							<li class="active"><a data-toggle="pill" href="#example12">Example 1</a></li>
				...
				<div class="col-md-10">
					<div class="tab-content">
						<div id="example12" class="tab-pane fade in active">
						...
						<div id="example6" class="tab-pane fade">
							...
							<form action="run.php" method="get">
								<div class="form-group">
									...
									<input type="number" class="form-control" id="emp_no" name="emp_no" value="">
								</div>
								<div class="form-group">
									<label for="from_date">From date: </label>
									<input type="date" class="form-control" id="from_date" name="from_date" value="">
